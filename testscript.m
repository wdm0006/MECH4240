...
model=Car(mass, wheel_base_width,wheel_base_length,r_eff,c_rr,cg_height,frontal_area,del);
...
% figure;
% plot3(n(2:end), e(2:end), terrain(round(n(2:end)),round(e(2:end))),'r');
% xlabel('NORTH');
% ylabel('EAST');
% zlabel('DOWN');
% xlim([0,tsize+1]);
